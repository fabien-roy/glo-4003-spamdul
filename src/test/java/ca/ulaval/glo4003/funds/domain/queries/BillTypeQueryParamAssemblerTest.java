...
//    BillQueryBuilder actualQueryBuilder = queryAssembler.assemble(queryBuilder, billQueryParams);
//
...
//    params.put(BILL_TYPE_PARAM.toString(), Collections.singletonList(billType.toString()));
//
//    BillQueryBuilder actualQueryBuilder = queryAssembler.assemble(queryBuilder, billQueryParams);
//
...
//    params.put(BILL_TYPE_PARAM.toString(), Collections.singletonList("invalidBillType"));
//
//    queryAssembler.assemble(queryBuilder, billQueryParams);
//  }
// }
