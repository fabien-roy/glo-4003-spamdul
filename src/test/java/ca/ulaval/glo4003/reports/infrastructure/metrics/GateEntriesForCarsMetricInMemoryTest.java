...
public class GateEntriesForCarsMetricInMemoryTest extends ReportMetricInMemoryTest {
  ...
  @Test
  public void givenMultipleEvents_whenCalculating_thenReturnNumberOfGateEnteredEventsForCars() {
    double numberOfGateEnteredEventsForCars = 1;
    data =
        aReportPeriodData()
            .withEvents(
    ...
    assertThat(data.getMetrics().get(0).getValue()).isEqualTo(numberOfGateEnteredEventsForCars);
  }
}
