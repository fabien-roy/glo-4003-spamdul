...
@Provider
public class NotFoundParkingAreaExceptionMapper
    implements ExceptionMapper<NotFoundParkingAreaException> {
  ...
  public Response toResponse(NotFoundParkingAreaException e) {
    NotFoundParkingAreaExceptionResponse notFoundParkingAreaExceptionResponse =
        new NotFoundParkingAreaExceptionResponse();
    notFoundParkingAreaExceptionResponse.error = ERROR;
    notFoundParkingAreaExceptionResponse.description = DESCRIPTION;

    return Response.status(Response.Status.NOT_FOUND)
        .entity(notFoundParkingAreaExceptionResponse)
