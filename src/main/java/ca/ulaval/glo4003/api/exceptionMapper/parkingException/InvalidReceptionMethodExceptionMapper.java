...
@Provider
public class InvalidReceptionMethodExceptionMapper
    implements ExceptionMapper<InvalidReceptionMethodException> {
  ...
  public Response toResponse(InvalidReceptionMethodException e) {
    InvalidReceptionMethodExceptionResponse invalidReceptionMethodExceptionResponse =
        new InvalidReceptionMethodExceptionResponse();
    ...
    return Response.status(Response.Status.BAD_REQUEST)
        .entity(invalidReceptionMethodExceptionResponse)
