...
public class ParkingAreaDimensionInMemory extends ReportDimension<ParkingAreaCode> {

  private final List<ParkingAreaCode> parkingAreaCodes;

  public ParkingAreaDimensionInMemory(List<ParkingAreaCode> parkingAreaCodes) {
