...
public class OffenseService {
  ...
  public Offense[] getAllOffenses() {
    ...
    return offenses.toArray(new Offense[0]);
  }
  ...
  public Offense isOffenseNeeded(OffenseValidationDto offenseValidationDto) {
    ...
    try {
      ...
      return createInvalidStickerOffense();
    }

    if (!parkingSticker.validateParkingStickerAreaCode(offenseValidation.getParkingAreaCode())) {
      return createWrongZoneOffense();
    }

    return createNoOffense();
  }
